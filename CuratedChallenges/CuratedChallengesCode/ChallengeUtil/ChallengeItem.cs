...
public class ChallengeItem
{
    ...
    public event Action<ChallengeItem> Selected;
    ...
    public void Init(Challenge challenge)
    {
        ...
        if (isCompleted && highestAscension > 0)
        {
            ...
            Root.AddChild(ascensionContainer);
        ...
        _tickbox.MouseFilter = Control.MouseFilterEnum.Stop;
        ...
        _nameLabel.MouseFilter = Control.MouseFilterEnum.Stop;
        _nameLabel.GuiInput += OnNameClicked;
        
        Root.CustomMinimumSize = new Vector2(400, 64);
    }
