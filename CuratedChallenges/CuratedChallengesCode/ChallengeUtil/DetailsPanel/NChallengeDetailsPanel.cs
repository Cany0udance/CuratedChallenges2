...
public class ChallengeDetailsPanel
{
    ...
    public void PositionPanel()
    {
        ...
        Root.Position = new Vector2(panelX, panelY);
        Root.CustomMinimumSize = new Vector2(panelWidth, 0);
    ...
    private void AttachTooltipHandlers(Control container)
    {
        ...
        {
            if (child is Label label && label.MouseFilter == Control.MouseFilterEnum.Stop)
            {
