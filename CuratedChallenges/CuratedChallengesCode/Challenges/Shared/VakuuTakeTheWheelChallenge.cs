...
public class VakuuTakeTheWheelChallenge : ChallengeDefinition
{
    public override string Id => "VAKUU_TAKE_THE_WHEEL";
    ...
    {
        var modifier = ModelDb.Modifier<VakuuTakeTheWheelModifier>().ToMutable() as VakuuTakeTheWheelModifier;
